...
hello! i'm dawn (fae/faer), an entity on the internet. this site exists#super[1] as something of a home page. if you actually want to find me for whatever reason, you can do so at:
...
#super[1]#sym.space.thin\though mostly only so i can play with #link("https://typst.app")[typst]'s html export
